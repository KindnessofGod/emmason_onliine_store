...
export default async function AboutPage({
  ...
  const [catalogue, sellers] = await Promise.all([allProducts(), verifiedSellers()]);

  const stats = [
    { value: `${catalogue.length}+`, label: dict.shop.title },
    { value: `${sellers.length}`, label: dict.home.sellersTitle },
