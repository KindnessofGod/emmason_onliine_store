              ...
              {recentOrders.map((order) => (
                <li key={order.id}>
                  <Link
                    ...
                    className="flex flex-wrap items-center gap-3 px-5 py-3 transition hover:bg-brand-50 dark:hover:bg-brand-900"
                  >
            ...
            <ul className="divide-y divide-border">
              {stats.lowStock.map((product) => (
                ...
                >
                  ...
                  <span className="shrink-0 rounded-full bg-accent-400/20 px-2 py-0.5 text-xs font-semibold text-accent-600">
                    {product.stock} left
                  </span>
                </li>
              ))}
