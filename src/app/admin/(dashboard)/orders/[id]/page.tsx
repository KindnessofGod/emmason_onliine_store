...
export default async function AdminOrderPage({
  ...
  return (
    <>
      <Link href="/admin/orders" className="text-sm text-muted-foreground hover:text-brand-600">
        ← Back to orders
      </Link>
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-[1fr_20rem]">
        <div className="space-y-6">
          <section className="rounded-xl border border-border bg-card">
            <h2 className="border-b border-border px-5 py-3 font-semibold">Items</h2>
              ...
              <Detail
                ...
                value={
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 text-brand-600 hover:underline dark:text-brand-300"
                  >
